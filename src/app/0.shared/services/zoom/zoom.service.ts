...
export class ZoomService {
    ...
    **********************************************/
    setInitZoomScale(pdfNum, pageNum) {
        console.log('>>> Calc init Zoom scale...');
        const containerSize = {
            width: CANVAS_CONFIG.maxContainerWidth,
            height: CANVAS_CONFIG.maxContainerHeight
        };
        // const pdfPage: any = this.pdfStorageService.getPdfPage(1, 1); 원래코드
        const pdfPage: any = this.pdfStorageService.getPdfPage(pdfNum, pageNum);
